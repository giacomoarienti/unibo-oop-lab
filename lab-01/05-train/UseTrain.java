class UseTrain {
    public static void main(String[] args) {
        ...
        System.out.println("TotOccupancyRatio: " + train.getTotOccupancyRatio());
        System.out.println("FirstClassOccupancyRatio: " + train.getFirstClassOccupancyRatio());
        System.out.println("SecondClassOccupancyRatio: " + train.getSecondClassOccupancyRatio());
        System.out.println();
        ...
        train.reserveSecondClassSeats(45);
        System.out.println("TotOccupancyRatio: " + train.getTotOccupancyRatio());
        System.out.println("FirstClassOccupancyRatio: " + train.getFirstClassOccupancyRatio());
        System.out.println("SecondClassOccupancyRatio: " + train.getSecondClassOccupancyRatio());
        System.out.println();
